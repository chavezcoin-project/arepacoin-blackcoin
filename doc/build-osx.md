...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build arepacoin, but if you want to, here's how:
...
commands:
    ...
    echo -e "rpcuser=arepacoinrpc\arepacoinrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Arepacoin/arepacoin.conf"
