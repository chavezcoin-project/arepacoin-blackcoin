...
void MineGenesis(CBlock genesis){
    ...
    uint256 newhash = genesis.GetPoWHash();
    uint256 besthash;
...
public:
    CMainParams() {
        ...
        genesis.nNonce   = 432297;

        // MineGenesis(genesis);

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xa11ea220b2b4c276957de518f57d17fe0d6cd08891b6cc77e91991dbbf0a5011"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("arepacoin.com", "testnet-seed.arepacoin.com"));
