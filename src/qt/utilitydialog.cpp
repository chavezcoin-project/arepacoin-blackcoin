    ...
    ui(new Ui::AboutDialog)
{
    ...
    tr("Copyright") + QString(" &copy; 2014-%1 ").arg(COPYRIGHT_YEAR) + tr("The Arepacoin Core developers")
        );
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Arepacoin Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Arepacoin Core is shutting down...") + "<br /><br />" +
